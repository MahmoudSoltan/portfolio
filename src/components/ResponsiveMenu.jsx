...
const ResponsiveMenu = ({showMenu,setShowMenu}) => {
  return (
    ...
    justify-between bg-gray-950 px-8 pb-6 text-black md-hidden rounded-r-xl shadow-md transition-all`}>
        <div>
            ...
            <nav className='mt-12'>
                ...
                <a href="#contact"><button className='px-3 py-1 cursor-pointer rounded-md bg-blue-500 text-white flex 
                items-center gap-1 shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#33CCCC,0_0_15px_33CCCC,0_0_30px_#33CCCC]
                 shadow-blue-500 border-blue-400 border-2'>Contact<FaChevronRight /></button></a>
                </ul>
            </nav>
        </div>
    </div>
